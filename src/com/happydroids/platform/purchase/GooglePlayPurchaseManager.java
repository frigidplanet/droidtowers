...
public class GooglePlayPurchaseManager extends PlatformPurchaseManger {
	...
	public GooglePlayPurchaseManager(DroidTowersGooglePlay droidTowersGooglePlay) {
		...
		itemSkus.put(UNLIMITED_299,
				"com.happydroids.droidtowers.version.unlimited299");
		itemSkus.put(ONE_TIME_DISCOUNT_199,
				"com.happydroids.droidtowers.version.unlimited199");
		itemSkus.put(UNLIMITED_99_XMAS,
				"com.happydroids.droidtowers.version.unlimited99.xmas");
	}
