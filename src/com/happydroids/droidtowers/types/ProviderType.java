...
public enum ProviderType {
	...
	HOUSING(APARTMENT, CONDO, PENTHOUSE), COMMERCIAL(ENTERTAINMENT, FOOD,
			OFFICE_SERVICES, HOTEL_ROOMS), TRANSPORT(STAIRS, ELEVATOR), PARKING(
			PARKING_RAMP, PARKING_SPACE), SERVICE(MAIDS, JANITORS, SECURITY,
			RESTROOM, PARKING);
