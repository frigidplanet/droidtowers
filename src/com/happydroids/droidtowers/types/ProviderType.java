...
public enum ProviderType {
	NONE, LOBBY, SKY_LOBBY, FOOD, ENTERTAINMENT, HOTEL_ROOMS, OFFICE_SERVICES, JANITORS, MAIDS, SECURITY, APARTMENT, CONDO, PENTHOUSE, STAIRS, ELEVATOR, SERVICE_ELEVATOR, RESTROOM, PARKING_RAMP, PARKING_SPACE,

	HOUSING(APARTMENT, CONDO, PENTHOUSE), COMMERCIAL(ENTERTAINMENT, FOOD, OFFICE_SERVICES, HOTEL_ROOMS), TRANSPORT(STAIRS, ELEVATOR), PARKING(PARKING_RAMP,
			PARKING_SPACE), SERVICE(MAIDS, JANITORS, SECURITY, RESTROOM, PARKING);
