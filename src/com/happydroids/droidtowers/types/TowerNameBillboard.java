...
public class TowerNameBillboard extends GameObject {
	...
	public TowerNameBillboard(NeighborGameGrid gameGrid) {
		...
		towerNameLabel = FontManager.BankGothic32.makeLabel(capitalize(gameGrid
	...
	public void draw(SpriteBatch spriteBatch) {
		...
		spriteBatch.draw(pollTexture, getX() + 12 + towerNameLabel.getWidth()
				/ 2, getY(), 8, towerNameLabel.getHeight() + 100);

		billboardArea.draw(spriteBatch, getX(), getY() + 100,
				towerNameLabel.getWidth() + 32, towerNameLabel.getHeight() + 8);
