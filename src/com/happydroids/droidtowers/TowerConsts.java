...
public class TowerConsts extends HappyDroidConsts {
	...
	public static final int NEIGHBOR_GROUND_HEIGHT = GRID_UNIT_SIZE
			* (LOBBY_FLOOR - 3);
	...
	public static final String GAME_SAVE_DIRECTORY = Gdx.app.getType() == Application.ApplicationType.Android ? "towergame/"
			: ".towergame/";
	...
	public static final int MAX_AVATARS = (Gdx.app.getType() == Application.ApplicationType.Android ? 20
			: 120);
	public static final float AVATAR_POPULATION_SCALE = 0.25f;
	public static final GridPoint SINGLE_POINT = new GridPoint(1, 1);
	public static final int[] NEGATIVE_BUTTON_KEYS = new int[] {
			InputSystem.Keys.BACK, InputSystem.Keys.ESCAPE };
	...
	public static final Array<Color> COLORS = new Array<Color>(new Color[] {
			Color.RED, Color.GREEN, Color.PINK, Color.WHITE, Color.BLUE,
			Color.LIGHT_GRAY, Color.GRAY, Color.DARK_GRAY, Color.ORANGE,
