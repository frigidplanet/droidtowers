...
public class Migration_GameSave_MoveMetadata extends
	...
	protected void process(ObjectNode node, String fileName) {
		ObjectNode gameSaveNode = getGameSaveUnlessFileFormatIsNewer(node,
				"com.happydroids.droidtowers.gamestate.GameSave", 3);
		...
		metadata.difficultyLevel = DifficultyLevel.valueOf(gameSaveNode.remove(
				"difficultyLevel").asText());
