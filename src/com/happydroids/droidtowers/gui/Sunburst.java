...
public class Sunburst extends Actor {
	...
	public Sunburst(Stage stage) {
		...
		String vertexShader = "attribute vec4 "
				...
				+ ShaderProgram.COLOR_ATTRIBUTE
				+ ";\n" //
				+ "   gl_Position =  u_transformMatrix * u_projectionViewMatrix * "
				+ ShaderProgram.POSITION_ATTRIBUTE + ";\n" //
				+ "}\n";
		...
		mesh = new Mesh(true, vertices.length, 0, VertexAttribute.Position(),
	...
	public void draw(SpriteBatch batch, float parentAlpha) {
		try {
			...
			shader.begin();
			shader.setUniformMatrix("u_transformMatrix",
					transformMatrix.setToRotation(0, 0, 1, getRotation()));
			shader.setUniformMatrix("u_projectionViewMatrix", getStage()
					.getCamera().combined);
